...
#         """Connected vertices."""
#         self.__neighbor_counts: dict[int, int] = {i: 0 for i in range(1, n + 1)}
...
#                 if self.__change_matrix[i, j] == 1:
#                     self.f += self.__weights[i, j]
#         return self.f
#
...
#         """
#         self.evaluate()
#         self.__edges_by_weight.sort(reverse=True)
#
#
# class Components:
#
